...
| Skill | Triggers on |
|---|---|
| `pdf` | PDF reading, extraction, merging, splitting, OCR, filling forms |
| `xlsx` | Spreadsheets, Excel, .xlsx, .csv, tabular data |
| `docx` | Word documents, .docx, reports, memos, letterheads |
| `pptx` | Slides, presentations, pitch decks, .pptx |
| `canvas-design` | Posters, visual art, static designs, .png/.pdf output |
| `algorithmic-art` | Generative art, p5.js, flow fields, particle systems |
| `web-artifacts-builder` | Complex HTML artifacts, React, Tailwind, shadcn/ui |
| `commit` | Git commits, commit messages, staging |
| `claude-api` | Anthropic SDK, Claude API integration, agent SDK |
| `mcp-builder` | MCP servers, tool integration, FastMCP |
| `prompt-creator` | Prompt engineering (this skill itself) |
| `schedule` | Scheduled/recurring tasks |
| `slack-gif-creator` | Animated GIFs for Slack |
| `theme-factory` | Styling artifacts, themes, colors/fonts |
| `ux-copy` | Microcopy, CTAs, error messages, button labels |
| `user-research` | Research plans, interview guides, usability tests |
| `research-synthesis` | Synthesizing interviews, surveys, NPS into insights |
| `design-critique` | Design feedback, mockup review, Figma critique |
| `accessibility-review` | WCAG audit, a11y, color contrast, keyboard nav |
| `design-handoff` | Developer specs, component props, design tokens |
| `design-system` | Design system audit, component documentation |
| `seo-review` | SEO audit, search visibility, featured snippets |
| `internal-comms` | Status reports, newsletters, incident reports |
| `doc-coauthoring` | Documentation, technical specs, decision docs |

If no skill matches, skip Phase 0.5 silently and proceed directly to Phase 1.
